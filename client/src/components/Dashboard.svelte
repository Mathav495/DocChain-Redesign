...
<div class="flex flex-col lg:gap-10 gap-5 justify-center">
    ...
    <div class="lg:w-6/12 w-full order-1 lg:order-2 flex flex-col gap-2">
      ...
      <div class="flex flex-row gap-2 md:gap-5">
        <div class="w-2/6 bg-red-100 h-auto md:h-60 rounded-3xl p-2 md:p-5 flex flex-col justify-between">
          <p class="text-sm md:text-xl font-bold text-center"><span class="md:block hidden">Document</span>Issued</p>

          <div class="flex flex-row gap-2 items-center justify-center md:justify-between">
            <div class="w-12 h-12 bg-white rounded-xl hidden md:flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8">
                <path fill-rule="evenodd" d="M5.625 1.5H9a3.75 3.75 0 013.75 3.75v1.875c0 1.036.84 1.875 1.875 1.875H16.5a3.75 3.75 0 013.75 3.75v7.875c0 1.035-.84 1.875-1.875 1.875H5.625a1.875 1.875 0 01-1.875-1.875V3.375c0-1.036.84-1.875 1.875-1.875zm6.905 9.97a.75.75 0 00-1.06 0l-3 3a.75.75 0 101.06 1.06l1.72-1.72V18a.75.75 0 001.5 0v-4.19l1.72 1.72a.75.75 0 101.06-1.06l-3-3z" clip-rule="evenodd" />
                <path d="M14.25 5.25a5.23 5.23 0 00-1.279-3.434 9.768 9.768 0 016.963 6.963A5.23 5.23 0 0016.5 7.5h-1.875a.375.375 0 01-.375-.375V5.25z" />
              </svg>
            </div>
            <p class="text-xl md:text-4xl font-bold text-red-500">{usage.initiated}</p>
          </div>
        </div>
        <div class="w-2/6 bg-yellow-100 h-auto md:h-60 rounded-3xl p-2 md:p-5 flex flex-col justify-between">
          <p class="text-sm md:text-xl font-bold text-center"><span class="md:block hidden">Document</span>Viewed</p>
          ...
          <div class="flex flex-row gap-2 items-center justify-center md:justify-between">
            ...
            <p class="text-xl md:text-4xl font-bold text-yellow-500">{usage.published}</p>
          </div>
        </div>
        <div class="w-2/6 bg-green-100 h-auto md:h-60 rounded-3xl p-2 md:p-5 flex flex-col justify-between">
          <p class="text-sm md:text-xl font-bold text-center"><span class="md:block hidden">Document</span>Verified</p>
          ...
          <div class="flex flex-row gap-2 items-center justify-center md:justify-between">
            ...
            <p class="text-xl md:text-4xl font-bold text-green-500">{usage.revoked}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="flex flex-row justify-between gap-5">
    ...
    <div class="flex flex-col w-full lg:w-8/12 gap-2">
      <div class="flex flex-col md:flex-row md:items-center justify-between mb-2">
        <h1 class="text-lg md:text-2xl font-bold">Document Access Log</h1>
        <div class="flex flex-row ml-auto">
          <div class="hidden md:flex h-8 w-8 items-center justify-center rounded-l-xl border-y-2 border-l-2 border-black">
          ...
          <input type="date" class="h-5 md:h-8 md:rounded-r-xl rounded-md md:rounded-l-none border-2 border-black bg-white px-2 outline-none md:mb-0 md:w-52" />
        </div>
      </div>
      <div class="flex text-base flex-col justify-between h-full">
        <div class="flex items-center font-bold gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="md:w-6 md:h-6 h-4 w-4">
    ...
    <!-- </div> -->
    <div class="w-4/12 bg-black rounded-xl text-white p-8 hidden lg:flex flex-col gap-3">
      <span class="leading-9 text-2xl font-bold"
