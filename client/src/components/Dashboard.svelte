...
<div class="flex flex-col lg:flex-row gap-4">
  <div class="lg:w-8/12 w-full h-60 lg:h-full lg:order-1 order-2 bg-blue-100 text-2xl p-4 rounded-md flex flex-col justify-end items-center font-bold text-blue-500">
    <div><Pagination /></div>
  </div>
