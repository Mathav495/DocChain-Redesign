...
<div class="flex flex-col gap-10 justify-center">
  <div class="flex flex-col lg:flex-row gap-5">
    <div class="flex order-2 lg:order-1 flex-col w-full lg:w-6/12 gap-3">
      ...
      <div class="graph-width md:w-full bg-blue-100 h-60 text-2xl rounded-3xl p-1 flex flex-col justify-end items-center font-bold text-blue-500">
        <div><Pagination /></div>
      </div>
    </div>
    <div class="lg:w-6/12 w-full order-1 lg:order-2 flex flex-col gap-3">
      ...
      <div class="flex flex-row gap-5">
        <div class="w-2/6 bg-red-100 h-60 rounded-3xl p-5 flex flex-col justify-between">
        ...
        <div class="w-2/6 bg-yellow-100 h-60 rounded-3xl p-5 flex flex-col justify-between">
        ...
        <div class="w-2/6 bg-green-100 h-60 rounded-3xl p-5 flex flex-col justify-between">
  ...
  <div class="flex flex-row justify-between gap-5">
    ...
    <!-- </div> -->
    <div class="w-4/12 bg-black rounded-xl text-white p-7 sm:hidden lg:flex flex-col gap-3">
