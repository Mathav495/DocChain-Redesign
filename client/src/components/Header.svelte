...
<div class="flex justify-between items-center" on:click|self={hideCard}>
  ...
  <div class="flex flex-row gap-5">
    <div class="relative flex-flex-col">
      ...
      <div class:show={hidden} class="transition-opacity duration-300 ease-in-out opacity-0 bg-black shadow-md shadow-gray-700 text-white absolute top-12 px-3 py-2 flex flex-col items-center justify-center rounded-2xl w-36 card-width">
