<script>
  ...
  onMount(async () => {
    ...
    document.getElementById("header_card").style.backgroundImage =
...
<div
  class="  w-full shadow-xl rounded-md flex items-center gap-1"
  style="background:{bgcolor}"
>
  <div
    id="header_card"
    class="w-full flex flex-col px-4 py-4"
  ...
  >
    <div class="flex gap-4">
      <img
        src={qr}
        alt="qrcode"
        class="w-20 h-20 rounded overflow-hidden lg:w-[100px] lg:h-[100px]"
      />
      <img
        src="/assets/sample.jpg"
        alt="qrcode"
        class="rounded overflow-hidden w-20 h-20 lg:w-[100px] lg:h-[100px]"
      />
    </div>
    <div class="pt-3">
      <h1 class="text-base font-medium tracking-wide text-white capitalize">
        {issuerName}
      </h1>
