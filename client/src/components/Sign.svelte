...
<div
  class="relative h-auto w-full flex flex-col items-center justify-center gap-3"
>
  {#if modal}
    <div
      class="w-full flex h-full bg-[#000000cc] absolute items-start justify-center p-4"
    >
      <div
        class="w-full lg:w-3/5 bg-white shadow-[0_0_8px_0_rgba(0,0,0,0.15)] p-5 rounded-md"
      >
        ...
        <div class="pt-5">
          <button
            ...
            class=" text-white font-medium bg-blue-700 py-2 px-4 hover:bg-blue-800 tracking-wider rounded text-lg"
          >
            Confirm Request
          </button>
        </div>
  ...
  <div class="w-8/12 flex flex-col gap-10">
    <div>
      ...
      <div class="flex items-center justify-start mt-2">
        <label for="pageNo" class="text-lg font-semibold w-1/2">
          Select Page No
        </label>
    ...
    <div>
      ...
      <div class="flex items-center justify-start mt-2">
        <div class="w-1/2">
          <button
            on:click={trigger}
            class="show-signature-overlay text-base rounded-md bg-indigo-500 hover:bg-indigo-600 px-3 py-1 text-white border-2 border-indig0-700 font-semibold"
          >
      ...
      <div class="flex items-center justify-start mt-2">
        ...
        <div class="flex items-center justify-start gap-5 w-1/2 px-4">
          <input
            ...
            name="Identity"
            id="Identity"
            value="819f82006a4c49263fcde49372eb58589194cc759fcc2c8758d804f97021cbe3"
          />
        </div>
      </div>
  ...
  <div class="w-4/12">
    ...
    {#if (src = imageUrl)}
      <img
        id="mycanvas1"
        class="w-full h-full rounded-md mb-40"
        src={imageUrl}
        alt="document"
      />
    {:else}
