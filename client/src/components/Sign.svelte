    ...
    <div>
      ...
      <div class="flex items-center justify-start mt-2">
        ...
        <div class="flex items-center justify-start gap-5 w-1/2 px-4">
          <button on:click={signaturePlacement} id="posControls" class:justify-end={position} class:bg-indigo-300={bgclr} class="show-signature-overlay w-8 h-5 border-2 rounded-full flex items-center px-0.5">
