<div class="shadow-around shadow-gray-300 border-l-8 border-red-500 rounded-md w-1/3 lg:w-full p-4 flex flex-col md:gap-1">
  ...
  <div class="flex flex-row justify-between">
    ...
    <div class="lg:w-10 lg:h-10 w-8 h-8 rounded-md hidden lg:flex items-center justify-center">
...
<div class="shadow-around shadow-gray-300 border-l-8 border-yellow-500 rounded-md w-1/3 lg:w-full p-4 flex flex-col md:gap-1">
...
<div class="shadow-around shadow-gray-200 border-l-8 border-green-500 rounded-md w-1/3 lg:w-full p-4 flex flex-col md:gap-1">
