  ...
  <div class="flex w-full flex-col xl:w-2/5 lg:w-2/5">
    ...
    <div class="border-2 border-gray-200 shadow-lg rounded-lg mt-4">
      <div class="mt-5 ml-4">
        ...
        <div class="relative">
          <div for="name" class="text-md font-bold uppercase leading-7 text-gray-600">DataHash</div>
          <div class="flex-col">
        ...
        <div class="relative mb-4">
          <div for="name" class="text-md font-bold uppercase leading-7 text-gray-600">fileHash</div>
          <div class="flex-col">
