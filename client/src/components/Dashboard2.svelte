...
<div class="flex flex-col gap-4">
  <div class="flex flex-row w-full gap-4">
    <div class="border-b-4 border-x border-t border-red-500 rounded-md w-1/3 lg:w-full p-4 flex flex-row items-center gap-4">
    ...
    <div class="border-b-4 border-x border-t border-yellow-500 rounded-md w-1/3 lg:w-full p-4 flex flex-row items-center gap-4">
      <div class="lg:w-10 lg:h-10 w-8 h-8 bg-white rounded-xl hidden md:flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="lg:w-8 lg:h-8 w-6 h-6">
    ...
    <div class="border-b-4 border-x border-t border-green-500 rounded-md w-1/3 lg:w-full p-4 flex flex-row items-center gap-4">
      <div class="lg:w-10 lg:h-10 w-8 h-8 bg-white rounded-xl hidden md:flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="lg:w-8 lg:h-8 w-6 h-6">
