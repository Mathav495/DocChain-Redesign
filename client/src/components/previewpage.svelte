...
<section class="text-gray-600 relative">
  <div class="container pt-2 mx-auto flex sm:flex-nowrap flex-wrap md:w-flex-col">
    <div class="lg:w-3/5 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10  flex w-full flex-col space-y-4 lg:order-none lg:block ">
