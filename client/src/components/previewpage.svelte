  ...
  <div class="container py-10 mx-auto flex sm:flex-nowrap flex-wrap md:w-flex-col">
    ...
    <div class="lg:w-2/5 md:w-1/2 bg-blue-300 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-5 rounded-md shadow-lg">
      ...
      <div class="p-2 w-full flex justify-between">
        <button class="flex mx-auto text-white bg-[#1c1c1c] border-0 py-2 px-8 focus:outline-none  rounded-lg text-lg uppercase" on:click|preventDefault={getsignature}>Sign</button>
        <button class="flex mx-auto text-white bg-[#1c1c1c] border-0 py-2 px-8 focus:outline-none  rounded-lg text-lg uppercase">publish</button>
      </div>
    </div>
  </div>
</section>
