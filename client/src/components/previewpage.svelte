...
<div class="container pt-2 mx-auto flex md:flex-nowrap flex-wrap md:w-flex-col">
  ...
  <div class="lg:w-2/5 md:w-1/2 bg-blue-300 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-5 rounded-md shadow-lg">
    ...
    <div class="relative mb-4">
      ...
      <div type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300  text-md text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">Wed Aug 17 2022 22:49:04 GMT+0530 (India Standard Time)</div>
    </div>
    <div class="relative mb-4">
      <div for="name" class="leading-7 text-md font-bold  text-gray-600">DOCUMENT_ID</div>
      <div type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300  text-md text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{documentID}</div>
    </div>
    <div class="relative mb-4">
      <div for="name" class="leading-7 text-md font-bold  text-gray-600">FILEHASH</div>
      <div type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300  text-md text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{fileHash}</div>
    </div>
    <div class="relative mb-4">
      <div for="name" class="leading-7 text-md font-bold  text-gray-600 uppercase">datahash</div>
      <div type="text" id="name" name="name" class="w-full bg-white rounded border border-gray-300  text-md text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{dataHash}</div>
    </div>
    <div class="p-2 w-full flex justify-between">
      <button class="flex mx-auto text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none  rounded-lg text-lg uppercase" on:click|preventDefault={getsignature}>Sign</button>
      <button class="flex mx-auto text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none  rounded-lg text-lg uppercase">publish</button>
    </div>
  </div>
</div>
<!-- </div> -->
