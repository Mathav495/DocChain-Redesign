        ...
        {#each newData as newData}
          <div class=" border-b-2 border-gray-200 flex font-semibold text-sm lg:text-base">
            ...
            <div class="py-3 w-1/4 bg-teal-100 tracking-wider flex gap-2 justify-center text-slate-900">
              <button class="hidden lg:block flex text-slate-800 border-2 border-indigo-500  py-1 px-2 hover:text-white  justify-center items-center focus:outline-none hover:bg-indigo-600 rounded text-base">Continue</button>
              <button
