...
<div class="flex lg:flex-row flex-col gap-5">
  ...
  <div class="bg-emerald-100 shadow-sm shadow-black mt-5 w-full lg:w-2/5 p-4 rounded-lg">
    ...
    <ul class="list-disc list-outside p-3">
      <li class="text-medium md:text-xl text-emerald-600 font-semibold tracking-wide">If you don't have Document ID,Select 'NO' .It will generate Document ID.</li>

      <li class="text-medium md:text-xl text-emerald-600 font-semibold tracking-wide mt-1">Otherwise select 'YES'</li>
    </ul>
  </div>
</div>
