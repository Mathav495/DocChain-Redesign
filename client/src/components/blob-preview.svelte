...
<div class="flex w-full flex-col">
  ...
  {:else}
    <div class=" relative flex max-w-full flex-col rounded-md">
      <canvas
        id="blobcanv"
        class="border-2 block rounded-md overflow-hidden max-w-full  shadow-[0_0_8px_0_rgba(0,0,0,0.15)]  mb-28 aspect-auto canvas"
      />
      <div
        class="flex justify-center items-center absolute bottom-20 inset-x-0 gap-3"
      >
