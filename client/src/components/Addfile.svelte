...
<div
  class="relative h-auto w-full flex flex-col items-center justify-center gap-3  p-4"
>
  <div
  ...
  <div
    class="{displaypreview
      ? 'flex'
      : 'hidden'} justify-between gap-4 pt-3 lg:w-[38.5rem]"
  >
    <div class="flex">
      <button
