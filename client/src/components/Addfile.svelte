...
<div class="relative h-auto w-full flex flex-col items-center justify-center  p-4">
  ...
  <form id="form" method="post" action="/docs/initiate" enctype="multipart/form-data" class="pt-3 w-full lg:w-[38.5rem]">
