  ...
  <div class="container px-1 py-10 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="flex-col lg:w-1/2 mx-auto w-full">
        <img
          alt="ecommerce"
          class=" w-full h-80 object-cover object-center rounded"
          src="https://images.unsplash.com/photo-1670189577367-2c6ef31a4b8c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
        />
        <div class="mt-2">
          <div
            class="pointer-events-auto flex w-full  divide-x divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"
          >
