...
<div id="header" class="lg:flex hidden justify-between items-center mb-4" on:click|self={hideCard}>
  <div class="text-lg md:text-xl flex items-center font-boldness gap-2">
    ...
    <h1 class="text-2xl font-bold">DocChain.io</h1>
  </div>

  <div class="flex flex-row gap-5">
    <div class="relative flex flex-row gap-2 md:gap-5">
      <a href="/" class="flex relative group items-center justify-center md:h-12 md:w-12 h-10 w-10 rounded-md text-black font-semibold bg-indigo-50">
