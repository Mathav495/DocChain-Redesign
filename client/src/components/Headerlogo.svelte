...
<div
  id="header"
  class="lg:flex hidden justify-between items-center mb-4"
...
>
  ...
  <div class="flex flex-row gap-5">
    <div class="relative flex flex-row gap-2 md:gap-5">
      ...
      <button
        on:click={navBtn}
        class="flex lg:hidden relative group items-center justify-center md:h-12 md:w-12 h-10 w-10 rounded-md text-black font-semibold bg-indigo-50"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
