<div class="flex flex-col gap-4">
  <div class="flex flex-row w-full h-20">
    <div class="w-24 bg-red-500 font-bold text-3xl flex items-center justify-center rounded-l-md">
    ...
    <div class="flex flex-row justify-between p-4 items-center shadow-md w-full h-full rounded-r-md">
      ...
      <p class="text-3xl text-red-500 font-bold">108</p>
    </div>
  </div>
  <div class="flex flex-row w-full h-20">
    <div class="w-24 bg-yellow-500 font-bold text-3xl flex items-center justify-center rounded-l-md">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="lg:w-8 lg:h-8 w-6 h-6">
  ...
  <div class="flex flex-row w-full h-20">
    <div class="w-24 bg-green-500 font-bold text-3xl flex items-center justify-center rounded-l-md">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="lg:w-8 lg:h-8 w-6 h-6">
