...
<main>
  ...
  >
    <div
      class="lg:w-88 md:w-3/8 hidden p-4 md:flex flex-col items-start justify-between"
    >
      <Logo />
      <Nav />
    ...
    <div
      class="lg:w-full relative overflow-auto md:w-5/8 w-full flex flex-col gap-4 bg-white text-gray-900 rounded-md p-4 ml-2 md:ml-0"
    >
