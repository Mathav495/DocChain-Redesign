      ...
      <form on:submit|preventDefault={onLogin}>
        <div class="w-96 mt-10 group">
          ...
          <div class="relative">
            ...
            <input bind:value={Email} novalidate="true" type="text" id="Email" placeholder={error.Email ? error.Email : 'Enter Your Email'} class="w-full mt-2 pl-9  placeholder:text-base  bg-black focus:bg-black text-blue-500 rounded border {error.Email ? 'border-red-500 ring-2 ring-red-500 placeholder:text-red-500' : 'border-gray-300 placeholder:text-blue-500'} focus:border-white focus:ring-1 focus:ring-white text-lg outline-none py-1 px-3 leading-8" />
          </div>
        </div>
