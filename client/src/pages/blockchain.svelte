<div class="flex flex-col bg-gray-200">
  ...
  >
    ...
    <h1 class="text-base tracking-normal">
      <strong class="hidden font-normal text-slate-700 lg:inline-flex"
        >This Document is Issued on Blockchain by</strong
      >
      <strong class=" hidden font-semibold text-slate-900 lg:inline-flex"
        >Print2Block</strong
      >
      powered by:
      <strong
  ...
  <div class="flex flex-col gap-4 py-28 lg:flex-row">
    ...
    <div
      class="order-1 flex w-full flex-col gap-4 px-6  lg:order-none lg:w-2/5 "
    >
      <div
        class="flex h-52 w-full flex-col gap-4 rounded-lg bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-400 p-4"
      >
        ...
        <div class="order-1 flex flex-col lg:order-none">
          <h1 class="mt-2 text-base font-normal text-white">SIDBI (DEMO)</h1>
      ...
      <div class=" hidden space-y-3 px-4 py-2 lg:block">
        ...
        <div>
          <h1 class="text-base font-normal text-slate-700">Date Published</h1>
          <h1 class="text-lg font-normal tracking-wide text-slate-900">
        ...
        <div>
          <h1 class="text-base font-normal text-slate-700">
            Data Hash (SHA256)
          </h1>
          <p
            class="break-all text-lg font-normal leading-relaxed tracking-normal text-slate-900"
        ...
        <button
          class="mx-auto mt-4 hidden  rounded-full border-2 border-sky-300 bg-sky-500 py-1 px-6 text-lg font-normal text-white lg:block"
          >Verify</button
        >
      </div>
    </div>
