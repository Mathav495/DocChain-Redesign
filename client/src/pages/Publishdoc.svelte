...
>
  <div
    class="width1200px width1024px width768px hidden p-8 md:flex flex-col items-start justify-between"
  >
    <Logo />
    <Nav />
  ...
  <div
    class="lg:w-full overflow-auto md:w-6/8 w-full flex flex-col gap-4 bg-white text-gray-900 rounded-md p-4 ml-2 md:ml-0"
  >
