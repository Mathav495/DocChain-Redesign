...
<div class="h-auto lg:h-screen relative lg:w-screen w-auto p-1 ">
  <div class="bg-black dash-bg-edge text-white h-full w-full">
    <div class="flex flex-row h-full py-3">
      <div
        class="md:w-4/12 lg:w-3/12 hidden  md-width py-5 md:flex flex-col items-center justify-between"
      >
        <Logo />
        <div
          class="md:w-4/12 lg:w-3/12 hidden md-width py-5 md:flex flex-col items-center justify-between"
      ...
      <div
        class="width-2 bg-white text-gray-900 content-bg-edge p-8 mr-3 w-full ml-10"
      >
        <Header />
        <div>
          <div
            class="mx-auto text-2xl text-teal-800 font-bold text-center mt-10 underline"
          >
            Publish to BlockChain:
          </div>
          <form
            on:submit={publishdoc}
            class="lg:w-2/3 mx-auto flex-col justify-center md:w-full mt-10"
          >
            <div
              class="mx-auto mt-1 flex-col items-center justify-center text-center "
            >
              <label
                for="signature"
                class="text-md block text-xl mt-5 font-bold text-teal-800 "
              >
                DocumentID:
              </label>
         ...
         border-gray-300 px-4 py-2 bg-black text-white
           placeholder:text-lg placeholder:text-center text-center text-lg
             focus:border-indigo-500 focus:ring-indigo-500 sm:text-md"
              ...
              <label
                for="signature"
                class="text-xl mt-2 block font-bold text-teal-800 "
              >
                SignatureID:
              </label>
