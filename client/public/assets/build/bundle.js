    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img4.src !== (img4_src_value = "/GitHub-Mark-32px.png")) attr_dev(img4, "src", img4_src_value);
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(window, "dragenter", prevent_default(/*dragenter_handler*/ ctx[25]), false, true, false),
    				listen_dev(window, "dragover", prevent_default(/*dragover_handler*/ ctx[26]), false, true, false),
