...
var app = (function () {
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<PDFPage> was created with unknown prop '${key}'`)
    })
  ...
  class PDFPage extends SvelteComponentDev {
    ...
    get page() {
      throw new Error(
        "<PDFPage>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }

    set page(value) {
      throw new Error(
        "<PDFPage>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }
  }
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          div0,
          "class",
          "resize-border h-full w-1 left-0 top-0 border-l cursor-ew-resize svelte-y5b9ho"
        )
        ...
        attr_dev(
          div1,
          "class",
          "resize-border w-full h-1 left-0 top-0 border-t cursor-ns-resize svelte-y5b9ho"
        )
        ...
        attr_dev(
          div2,
          "class",
          "resize-border w-full h-1 left-0 bottom-0 border-b cursor-ns-resize svelte-y5b9ho"
        )
        ...
        attr_dev(
          div3,
          "class",
          "resize-border h-full w-1 right-0 top-0 border-r cursor-ew-resize svelte-y5b9ho"
        )
        ...
        attr_dev(
          div4,
          "class",
          "resize-corner left-0 top-0 cursor-nwse-resize transform\n      -translate-x-1/2 -translate-y-1/2 md:scale-25 svelte-y5b9ho"
        )
        ...
        attr_dev(
          div5,
          "class",
          "resize-corner right-0 top-0 cursor-nesw-resize transform\n      translate-x-1/2 -translate-y-1/2 md:scale-25 svelte-y5b9ho"
        )
        add_location(div5, file_1, 162, 4, 4796)
        attr_dev(div6, "data-direction", "left-bottom")
        attr_dev(
          div6,
          "class",
          "resize-corner left-0 bottom-0 cursor-nesw-resize transform\n      -translate-x-1/2 translate-y-1/2 md:scale-25 svelte-y5b9ho"
        )
        add_location(div6, file_1, 166, 4, 4963)
        attr_dev(div7, "data-direction", "right-bottom")
        attr_dev(
          div7,
          "class",
          "resize-corner right-0 bottom-0 cursor-nwse-resize transform\n      translate-x-1/2 translate-y-1/2 md:scale-25 svelte-y5b9ho"
        )
        add_location(div7, file_1, 170, 4, 5134)
        attr_dev(
          div8,
          "class",
          "absolute w-full h-full cursor-grab svelte-y5b9ho"
        )
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$set = ($$props) => {
      ...
      if ("pageScale" in $$props)
        $$invalidate(16, (pageScale = $$props.pageScale))
    }
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("operation" in $$props)
        $$invalidate(5, (operation = $$props.operation))
  ...
  function tapout(node) {
    function handleTouchstart(event) {
      if (
        !Array.from(event.touches).some((touch) => node.contains(touch.target))
      )
  ...
  function create_if_block(ctx) {
    ...
    const block = {
      ...
      p: function update(ctx, dirty) {
        ...
        if (
          (dirty[0] & /*_fontFamily, _size, _lineHeight*/ 56) |
          (dirty[1] & /*$$scope*/ 256)
        ) {
  ...
  function create_default_slot$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        div5 = element("div")
        img3 = element("img")
        if (img0.src !== (img0_src_value = "/line_height.svg"))
        ...
        if (img2.src !== (img2_src_value = "/text-family.svg"))
        ...
        if (/*_fontFamily*/ ctx[5] === void 0)
          add_render_callback(() =>
            /*select_change_handler*/ ctx[34].call(select)
          )
        add_location(select, file$3, 215, 10, 6595)
        attr_dev(
          path,
          "d",
          "M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757\n                6.586 4.343 8z"
        )
        ...
        if (img3.src !== (img3_src_value = "/delete.svg"))
        ...
        attr_dev(
          div6,
          "class",
          "h-full flex justify-center items-center bg-gray-300 border-b\n      border-gray-400"
        )
      ...
      p: function update(ctx, dirty) {
        if (
          dirty[0] & /*_lineHeight*/ 16 &&
          to_number(input0.value) !== /*_lineHeight*/ ctx[4]
        ) {
          set_input_value(input0, /*_lineHeight*/ ctx[4])
        }
        ...
        if (
          dirty[0] & /*_size*/ 8 &&
          to_number(input1.value) !== /*_size*/ ctx[3]
        ) {
          set_input_value(input1, /*_size*/ ctx[3])
        }
    ...
    const block = {
      c: function create() {
        ...
        toggle_class(
          div0,
          "editing",
          ["edit", "tool"].includes(/*operation*/ ctx[8])
        )
      ...
      m: function mount(target, anchor, remount) {
        ...
        dispose = [
          ...
          listen_dev(
            div1,
            "paste",
            prevent_default(/*onPaste*/ ctx[15]),
            false,
            true,
            false
          ),
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    $$self.$set = ($$props) => {
      ...
      if ("lineHeight" in $$props)
        $$invalidate(23, (lineHeight = $$props.lineHeight))
      if ("x" in $$props) $$invalidate(0, (x = $$props.x))
      if ("y" in $$props) $$invalidate(1, (y = $$props.y))
      if ("fontFamily" in $$props)
        $$invalidate(24, (fontFamily = $$props.fontFamily))
      if ("pageScale" in $$props)
        $$invalidate(25, (pageScale = $$props.pageScale))
    }
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("_lineHeight" in $$props)
        $$invalidate(4, (_lineHeight = $$props._lineHeight))
      if ("_fontFamily" in $$props)
        $$invalidate(5, (_fontFamily = $$props._fontFamily))
      if ("dx" in $$props) $$invalidate(6, (dx = $$props.dx))
      if ("dy" in $$props) $$invalidate(7, (dy = $$props.dy))
      if ("operation" in $$props)
        $$invalidate(8, (operation = $$props.operation))
    }
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          div1,
          "class",
          "absolute right-0 bottom-0 w-10 h-10 bg-green-400 rounded-full\n      cursor-nwse-resize transform translate-x-1/2 translate-y-1/2 md:scale-25"
        )
        ...
        set_style(
          div4,
          "height",
          /*width*/ (ctx[0] + /*dw*/ ctx[8]) / /*ratio*/ ctx[9] + "px"
        )
        set_style(
          div4,
          "transform",
  ...
  function instance$6($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<Drawing> was created with unknown prop '${key}'`)
    })
    ...
    $$self.$set = ($$props) => {
      if ("originWidth" in $$props)
        $$invalidate(14, (originWidth = $$props.originWidth))
      if ("originHeight" in $$props)
        $$invalidate(15, (originHeight = $$props.originHeight))
      if ("width" in $$props) $$invalidate(0, (width = $$props.width))
  ...
  class Drawing extends SvelteComponentDev {
    constructor(options) {
      ...
      if (/*originWidth*/ ctx[14] === undefined && !("originWidth" in props)) {
        console.warn(
          "<Drawing> was created without expected prop 'originWidth'"
        )
      }

      if (
        /*originHeight*/ ctx[15] === undefined &&
        !("originHeight" in props)
      ) {
        console.warn(
          "<Drawing> was created without expected prop 'originHeight'"
        )
      }
    ...
    get originWidth() {
      throw new Error(
        "<Drawing>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }

    set originWidth(value) {
      throw new Error(
        "<Drawing>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }
  ...
  function instance$7($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<DrawingCanvas> was created with unknown prop '${key}'`)
    })
  ...
  function create_if_block_4(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div, file$6, 237, 4, 7635)
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor)
  ...
  function create_else_block(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(span, file$6, 284, 6, 10339)
        attr_dev(
          div,
          "class",
          "w-full flex-grow flex justify-center items-center"
        )
        add_location(div, file$6, 283, 4, 10269)
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor)
        append_dev(div, span)
  ...
  function create_if_block$1(ctx) {
    ...
    const block = {
      ...
      p: function update(ctx, dirty) {
        ...
        if (
          dirty[0] &
          /*selectPage, pages, selectedPageIndex, pagesScale, allObjects, updateObject, deleteObject, selectFontFamily, onMeasure*/ 254012
        ) {
  ...
  function create_if_block_3(ctx) {
    ...
    const block = {
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.path = /*object*/ ctx[43].path
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.x = /*object*/ ctx[43].x
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.y = /*object*/ ctx[43].y
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.width = /*object*/ ctx[43].width
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.originWidth = /*object*/ ctx[43].originWidth
        if (dirty[0] & /*allObjects, pages*/ 20)
          drawing_changes.originHeight = /*object*/ ctx[43].originHeight
        if (dirty[0] & /*pagesScale, pages*/ 12)
          drawing_changes.pageScale = /*pagesScale*/ ctx[3][/*pIndex*/ ctx[42]]
  ...
  function create_if_block_2(ctx) {
    ...
    const block = {
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.text = /*object*/ ctx[43].text
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.x = /*object*/ ctx[43].x
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.y = /*object*/ ctx[43].y
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.size = /*object*/ ctx[43].size
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.lineHeight = /*object*/ ctx[43].lineHeight
        if (dirty[0] & /*allObjects, pages*/ 20)
          text_1_changes.fontFamily = /*object*/ ctx[43].fontFamily
        if (dirty[0] & /*pagesScale, pages*/ 12)
          text_1_changes.pageScale = /*pagesScale*/ ctx[3][/*pIndex*/ ctx[42]]
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      ...
      p: function update(new_ctx, dirty) {
        ...
        const image_changes = {}
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.file = /*object*/ ctx[43].file
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.payload = /*object*/ ctx[43].payload
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.x = /*object*/ ctx[43].x
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.y = /*object*/ ctx[43].y
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.width = /*object*/ ctx[43].width
        if (dirty[0] & /*allObjects, pages*/ 20)
          image_changes.height = /*object*/ ctx[43].height
        if (dirty[0] & /*pagesScale, pages*/ 12)
          image_changes.pageScale = /*pagesScale*/ ctx[3][/*pIndex*/ ctx[42]]
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: '(270:16) {#if object.type === \\"image\\"}',
      ctx,
    })
  ...
  // (269:14) {#each allObjects[pIndex] as object (object.id)}
  function create_each_block_1(key_1, ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(269:14) {#each allObjects[pIndex] as object (object.id)}",
      ctx,
    })
  ...
  // (264:6) {#each pages as page, pIndex (page)}
  function create_each_block$1(key_1, ctx) {
    ...
    const block = {
      ...
      c: function create() {
        ...
        set_style(
          div0,
          "transform",
          "scale(" + /*pagesScale*/ ctx[3][/*pIndex*/ ctx[42]] + ")"
        )
        set_style(div0, "touch-action", "none")
        add_location(div0, file$6, 267, 12, 8923)
        attr_dev(div1, "class", "relative shadow-lg")
        toggle_class(
          div1,
          "shadow-outline",
          /*pIndex*/ ctx[42] === /*selectedPageIndex*/ ctx[5]
        )
        add_location(div1, file$6, 265, 10, 8741)
        attr_dev(
          div2,
          "class",
          "p-5 w-full flex flex-col items-center overflow-hidden"
        )
        add_location(div2, file$6, 264, 8, 8582)
        this.first = div2
      },
      m: function mount(target, anchor, remount) {
        insert_dev(target, div2, anchor)
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (
          dirty[0] &
          /*allObjects, pages, pagesScale, updateObject, deleteObject, selectFontFamily*/ 106524
        ) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(264:6) {#each pages as page, pIndex (page)}",
      ctx,
    })
  ...
  function create_fragment$8(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(input0, file$6, 178, 4, 5299)
        attr_dev(input1, "type", "file")
        attr_dev(input1, "id", "image")
        attr_dev(input1, "name", "image")
        attr_dev(input1, "class", "hidden")
        add_location(input1, file$6, 179, 4, 5384)
        attr_dev(
          label0,
          "class",
          "whitespace-no-wrap bg-blue-500 hover:bg-blue-700 text-white\n      font-bold py-1 px-3 md:px-4 rounded mr-3 cursor-pointer md:mr-4"
        )
        attr_dev(label0, "for", "pdf")
        add_location(label0, file$6, 180, 4, 5475)
        if (img0.src !== (img0_src_value = "image.svg"))
          attr_dev(img0, "src", img0_src_value)
        attr_dev(img0, "alt", "An icon for adding images")
        add_location(img0, file$6, 197, 8, 6035)
        attr_dev(
          label1,
          "class",
          "flex items-center justify-center h-full w-8 hover:bg-gray-500\n        cursor-pointer"
        )
        attr_dev(label1, "for", "image")
        toggle_class(
          label1,
          "cursor-not-allowed",
          /*selectedPageIndex*/ ctx[5] < 0
        )
        toggle_class(label1, "bg-gray-500", /*selectedPageIndex*/ ctx[5] < 0)
        add_location(label1, file$6, 190, 6, 5784)
        if (img1.src !== (img1_src_value = "notes.svg"))
          attr_dev(img1, "src", img1_src_value)
        attr_dev(img1, "alt", "An icon for adding text")
        add_location(img1, file$6, 207, 8, 6396)
        attr_dev(
          label2,
          "class",
          "flex items-center justify-center h-full w-8 hover:bg-gray-500\n        cursor-pointer"
        ...
        add_location(label2, file$6, 199, 6, 6112)
        if (img2.src !== (img2_src_value = "gesture.svg"))
          attr_dev(img2, "src", img2_src_value)
        attr_dev(img2, "alt", "An icon for adding drawing")
        add_location(img2, file$6, 216, 8, 6734)
        attr_dev(
          label3,
          "class",
          "flex items-center justify-center h-full w-8 hover:bg-gray-500\n        cursor-pointer"
        ...
        add_location(label3, file$6, 209, 6, 6471)
        attr_dev(
          div0,
          "class",
          "relative mr-3 flex h-8 bg-gray-400 rounded-sm overflow-hidden\n      md:mr-4"
        )
        add_location(div0, file$6, 187, 4, 5682)
        if (img3.src !== (img3_src_value = "/edit.svg"))
          attr_dev(img3, "src", img3_src_value)
        attr_dev(img3, "class", "mr-2")
        attr_dev(img3, "alt", "a pen, edit pdf name")
        add_location(img3, file$6, 220, 6, 6902)
        attr_dev(input2, "placeholder", "Rename your PDF here")
        attr_dev(input2, "type", "text")
        attr_dev(input2, "class", "flex-grow bg-transparent")
        add_location(input2, file$6, 221, 6, 6972)
        attr_dev(
          div1,
          "class",
          "justify-center mr-3 md:mr-4 w-full max-w-xs hidden md:flex"
        )
        add_location(div1, file$6, 219, 4, 6823)
        attr_dev(
          button,
          "class",
          "w-20 bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3\n      md:px-4 mr-3 md:mr-4 rounded"
        )
        toggle_class(
          button,
          "cursor-not-allowed",
          /*pages*/ ctx[2].length === 0 ||
            /*saving*/ ctx[6] ||
            !(/*pdfFile*/ ctx[0])
        )
        toggle_class(
        ...
        add_location(button, file$6, 223, 4, 7098)
        if (img4.src !== (img4_src_value = "/GitHub-Mark-32px.png"))
          attr_dev(img4, "src", img4_src_value)
        attr_dev(img4, "alt", "A GitHub icon leads to personal GitHub page")
        add_location(img4, file$6, 233, 6, 7505)
        attr_dev(a, "href", "https://github.com/ShizukuIchi/pdf-editor")
        add_location(a, file$6, 232, 4, 7446)
        attr_dev(
          div2,
          "class",
          "fixed z-10 top-0 left-0 right-0 h-12 flex justify-center items-center\n    bg-gray-200 border-b border-gray-300"
        )
        add_location(div2, file$6, 175, 2, 5166)
        attr_dev(
          main,
          "class",
          "flex flex-col items-center py-16 bg-gray-100 min-h-screen"
        )
        add_location(main, file$6, 174, 0, 5091)
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
      ...
      m: function mount(target, anchor, remount) {
        ...
        dispose = [
          listen_dev(
            window,
            "dragenter",
            prevent_default(/*dragenter_handler*/ ctx[25]),
            false,
            true,
            false
          ),
          listen_dev(
            window,
            "dragover",
            prevent_default(/*dragover_handler*/ ctx[26]),
            false,
            true,
            false
          ),
          listen_dev(
            window,
            "drop",
            prevent_default(/*onUploadPDF*/ ctx[8]),
            false,
            true,
            false
          ),
      ...
      p: function update(ctx, dirty) {
        ...
        if (
          (!current || dirty[0] & /*saving*/ 64) &&
          t10_value !==
            (t10_value = /*saving*/ (ctx[6] ? "Saving" : "Save") + "")
        )
  ...
  function instance$8($$self, $$props, $$invalidate) {
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("pagesScale" in $$props)
        $$invalidate(3, (pagesScale = $$props.pagesScale))
      if ("allObjects" in $$props)
        $$invalidate(4, (allObjects = $$props.allObjects))
      if ("currentFont" in $$props) currentFont = $$props.currentFont
      if ("focusId" in $$props) focusId = $$props.focusId
      if ("selectedPageIndex" in $$props)
        $$invalidate(5, (selectedPageIndex = $$props.selectedPageIndex))
      if ("saving" in $$props) $$invalidate(6, (saving = $$props.saving))
      if ("addingDrawing" in $$props)
        $$invalidate(7, (addingDrawing = $$props.addingDrawing))
    }
